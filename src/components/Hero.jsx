...
export default function Hero() {
  return (
    <section className="h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-r from-black via-gray-900 to-black text-white px-10 pt-20 md:pt-0">
      ...
      <motion.div 
        ...
        transition={{ duration: 1, ease: "easeOut", delay: 0.3 }}
      >
        <div className="w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-gray-700 shadow-2xl hover:scale-105 transition">
          <img 
            src={profile} 
            alt="Yuvraj Bisht" 
            className="w-full h-full object-cover"
